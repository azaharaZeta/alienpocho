/* =============================================================================
   ...
   -----------------------------------------------------------------------------
   El "estado de partida" y las reglas: estado `game`, interacción con circuitos
   (coger/soltar/activar zócalo + condición de victoria), instancia del mundo y
   transiciones flip-screen entre salas (checkExits) y reinicio (resetGame).

   La FÍSICA vive en physics.js, la ENTIDAD jugador en player.js, los DATOS del mapa
   en data/rooms.js (los arma world.js). Aquí se orquesta el estado sobre todo eso.
   ============================================================================= */
"use strict";
